...
<body class="d-flex flex-column h-100">
    <header>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item mr-0">
                        <!-- <button id="servicesbtn" >Click</button> -->
                        <input type="image" src="../../public/img/services.png" name="services-toggle" id="servicesbtn" width="20px" height="20px">  
                    </li>
        ...
        <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
                        ...
                        <!-- The Modal -->
                        <div id="services" class="collapsed">
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-10 m-auto">
                                                <img src="../../public/img/services.png" width="100%" alt="Services">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" onclick="Hello()">Close</button>
                                    </div>
                                    <script>
                                        function Hello() {
